...
{
    public class StartCommand : CommandBase, IDisposable
    {
        ...
        public StartCommand(IBusRoutingProvider busRouterService, BusRouterControlContextStore busRouterControlContextStore)
        {
        ...
        {
            _busRoutingProvider.StartThreads();
        }
